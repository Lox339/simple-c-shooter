...
- [ ] 2. Реализация Core Engine (C) - базовая структура
  - [ ] 2.1 Создать основной игровой цикл и управление состоянием
  ...
  - [ ] 2.2 Реализовать систему обработки ввода
  ...
  - [ ] 2.3 Создать систему управления игровыми объектами
